...
//   // When new expense type is added from modal
//   const handleExpenseTypeCreated = (newType) => {
//     setExpenseTypes((prev) => [...prev, newType]);
//     setSelectedExpense(newType._id);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="col-span-2 flex items-end gap-3">
            <div className="flex-1">
              ...
              <Select
                value={
                  expenseOptions.find((opt) => opt.value === selectedExpense) ||
                  null
                }
                onChange={(selectedOption) =>
                  setSelectedExpense(selectedOption ? selectedOption.value : "")
                }
